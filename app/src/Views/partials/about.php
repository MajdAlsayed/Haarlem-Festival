...
<section class="about-section">
    <div class="container">
        <h2 class="section-title section-title--underlined about-heading">
            <?= htmlspecialchars($h['about_heading'] ?? '') ?>
        </h2>
        <div class="about-grid">
            ...
            <div class="about-content">
                ...
                <a href="<?= htmlspecialchars($h['about_more_href'] ?? '#') ?>" class="btn btn--light about-link"><?= htmlspecialchars($h['about_more_label'] ?? '') ?></a>
            </div>
        </div>
    </div>
</section>
