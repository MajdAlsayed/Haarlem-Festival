...
<head>
    <meta charset="UTF-8">
    <title>Edit Location — Haarlem Festival</title>
...
<main class="admin-cms-wrap">
    ...
    <form method="post" action="/admin/cms/history/location/<?= htmlspecialchars($viewModel->slug) ?>">
