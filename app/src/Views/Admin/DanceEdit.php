...
<body class="admin-page" data-upload-csrf="<?= $h($vm->uploadCsrf) ?>" data-upload-url="/admin/cms/upload">
...
<main class="admin-main">
    <div class="admin-container admin-container--wide">
        ...
        <?php if ($vm->error !== null): ?>
            <div class="admin-alert admin-alert-error"><?= $h($vm->error) ?></div>
        <?php endif; ?>

        <form method="post" action="/admin/cms/dance" class="admin-form admin-form--wide">
            <input type="hidden" name="_csrf" value="<?= $h($vm->csrf) ?>">
            ...
            <div class="admin-field">
                ...
                <input type="text" id="dance_page_title" name="dance_page_title" required maxlength="120"
                       value="<?= $h($vm->dancePageTitle) ?>" class="admin-input">
            </div>
            ...
            <fieldset class="admin-fieldset">
                ...
                <div class="admin-field">
                    ...
                    <input type="text" id="about_section_heading" name="about_section_heading" required maxlength="120"
                           value="<?= $h($vm->aboutSectionHeading) ?>" class="admin-input">
                </div>
                <div class="admin-field">
                    ...
                    <input type="text" id="featured_section_title" name="featured_section_title" required maxlength="120"
                           value="<?= $h($vm->featuredSectionTitle) ?>" class="admin-input">
                </div>
                <div class="admin-field">
                    ...
                    <input type="text" id="all_events_section_title" name="all_events_section_title" required maxlength="120"
                           value="<?= $h($vm->allEventsSectionTitle) ?>" class="admin-input">
                </div>
                <div class="admin-field">
                    ...
                    <input type="text" id="artists_section_title" name="artists_section_title" required maxlength="120"
                           value="<?= $h($vm->artistsSectionTitle) ?>" class="admin-input">
                </div>
            </fieldset>
            ...
            <div class="admin-field">
                ...
                <textarea id="hero_subtitle" class="cms-wysiwyg admin-input admin-textarea" name="hero_subtitle" required rows="4"><?= $h($vm->heroSubtitle) ?></textarea>
            </div>
            ...
            <div class="admin-field">
                ...
                <input type="text" id="hero_cta_label" name="hero_cta_label" required maxlength="120"
                       value="<?= $h($vm->heroCtaLabel) ?>" class="admin-input">
            </div>
            ...
            <fieldset class="admin-fieldset">
                ...
                <div class="admin-field">
                    ...
                    <textarea id="about_p1" class="cms-wysiwyg admin-input admin-textarea" name="about_p1" rows="5"><?= $h($vm->aboutP1) ?></textarea>
                </div>
                <div class="admin-field">
                    <label for="about_p2">Paragraph 2</label>
                    <textarea id="about_p2" class="cms-wysiwyg admin-input admin-textarea" name="about_p2" rows="4"><?= $h($vm->aboutP2) ?></textarea>
                </div>
                <div class="admin-field">
                    <label for="about_p3">Paragraph 3 (rich text)</label>
                    <textarea id="about_p3" class="cms-wysiwyg admin-input admin-textarea" name="about_p3" rows="5"><?= $h($vm->aboutP3) ?></textarea>
                </div>
            </fieldset>
            ...
            <fieldset class="admin-fieldset">
                ...
                <div class="admin-field">
                    ...
                    <textarea id="friday_images_lines" class="admin-input admin-textarea" name="friday_images_lines" maxlength="8000" style="font-family:monospace;font-size:0.9rem;min-height:7rem;"><?= $h($vm->fridayImagesLines) ?></textarea>
                </div>
                <div class="admin-field">
                    <label for="saturday_images_lines">Saturday tab</label>
                    <textarea id="saturday_images_lines" class="admin-input admin-textarea" name="saturday_images_lines" maxlength="8000" style="font-family:monospace;font-size:0.9rem;min-height:7rem;"><?= $h($vm->saturdayImagesLines) ?></textarea>
                </div>
                <div class="admin-field">
                    <label for="sunday_images_lines">Sunday tab</label>
                    <textarea id="sunday_images_lines" class="admin-input admin-textarea" name="sunday_images_lines" maxlength="8000" style="font-family:monospace;font-size:0.9rem;min-height:7rem;"><?= $h($vm->sundayImagesLines) ?></textarea>
                </div>
                <div class="admin-field">
                    <label for="featured_genre_labels_lines">Featured genre pills (one per line, order matches cards)</label>
                    <textarea id="featured_genre_labels_lines" class="admin-input admin-textarea" name="featured_genre_labels_lines" maxlength="500" style="font-family:monospace;font-size:0.9rem;min-height:4rem;"><?= $h($vm->featuredGenreLabelsLines) ?></textarea>
                </div>
            </fieldset>
            ...
            <fieldset class="admin-fieldset">
                ...
                <div class="admin-field">
                    ...
                    <input type="text" id="breadcrumb_home_label" name="breadcrumb_home_label" required maxlength="40"
                           value="<?= $h($vm->breadcrumbHomeLabel) ?>" class="admin-input">
                </div>
                <div class="admin-field">
                    ...
                    <input type="text" id="breadcrumb_dance_label" name="breadcrumb_dance_label" required maxlength="40"
                           value="<?= $h($vm->breadcrumbDanceLabel) ?>" class="admin-input">
                </div>
                <div class="admin-field">
                    ...
                    <input type="text" id="event_detail_list_path" name="event_detail_list_path" required maxlength="120"
                           value="<?= $h($vm->eventDetailListPath) ?>" class="admin-input" placeholder="/dance">
                </div>
                <div class="admin-field">
                ...
                <div class="admin-field">
                    ...
                    <textarea id="event_detail_gallery_lines" name="event_detail_gallery_lines" class="admin-input admin-textarea" maxlength="2000" style="font-family:monospace;font-size:0.9rem;min-height:5rem;"><?= $h($vm->eventDetailGalleryLines) ?></textarea>
                </div>
                <div class="admin-field">
                    ...
                    <input type="text" id="default_event_day" name="default_event_day" required maxlength="20" pattern="[a-z]+"
                           value="<?= $h($vm->defaultEventDay) ?>" class="admin-input" placeholder="friday">
                </div>
                <div class="admin-field">
                    ...
                    <input type="text" id="event_detail_venue_country" name="event_detail_venue_country" required maxlength="80"
                           value="<?= $h($vm->eventDetailVenueCountry) ?>" class="admin-input">
                </div>
                <div class="admin-field" style="display:flex;gap:1rem;flex-wrap:wrap;">
                    <div style="flex:1;min-width:10rem;">
                        ...
                        <input type="text" id="default_map_lat" name="default_map_lat" required maxlength="20"
                               value="<?= $h($vm->defaultMapLat) ?>" class="admin-input">
                    </div>
                    <div style="flex:1;min-width:10rem;">
                        ...
                        <input type="text" id="default_map_lon" name="default_map_lon" required maxlength="20"
                               value="<?= $h($vm->defaultMapLon) ?>" class="admin-input">
                    </div>
                </div>
                <div class="admin-field">
                    <label for="venue_coordinates_json">Venue → map pin (JSON object)</label>
                    <textarea id="venue_coordinates_json" name="venue_coordinates_json" class="admin-input admin-textarea" maxlength="16000" style="font-family:monospace;font-size:0.85rem;min-height:14rem;"><?= $h($vm->venueCoordinatesJson) ?></textarea>
                </div>
            </fieldset>
            ...
            <fieldset class="admin-fieldset">
                ...
                <div class="admin-field">
                    ...
                    <input type="text" id="dance_images_base_path" name="dance_images_base_path" required maxlength="120"
                           value="<?= $h($vm->artistDetailDanceImagesBasePath) ?>" class="admin-input" placeholder="/images/dance/">
                </div>
                <div class="admin-field">
                    ...
                    <input type="text" id="artist_detail_photos_context_hero" name="artist_detail_photos_context_hero" required maxlength="80" pattern="[A-Za-z0-9_]+"
                           value="<?= $h($vm->artistDetailPhotosContextHero) ?>" class="admin-input">
                </div>
                <div class="admin-field">
                    ...
                    <input type="text" id="artist_detail_photos_context_schedule" name="artist_detail_photos_context_schedule" required maxlength="80" pattern="[A-Za-z0-9_]+"
                           value="<?= $h($vm->artistDetailPhotosContextSchedule) ?>" class="admin-input">
                </div>
                <div class="admin-field">
                    ...
                    <input type="text" id="artist_detail_photos_context_music" name="artist_detail_photos_context_music" required maxlength="80" pattern="[A-Za-z0-9_]+"
                           value="<?= $h($vm->artistDetailPhotosContextMusic) ?>" class="admin-input">
                </div>
                <div class="admin-field">
                    ...
                    <input type="text" id="artist_detail_hero_fallback" name="artist_detail_hero_fallback" required maxlength="255"
                           value="<?= $h($vm->artistDetailHeroFallback) ?>" class="admin-input">
                </div>
                <div class="admin-field">
                    <label for="artist_detail_schedule_fallbacks_json">Schedule image fallbacks (slug → path; include <code>"default"</code>)</label>
                    <textarea id="artist_detail_schedule_fallbacks_json" name="artist_detail_schedule_fallbacks_json" class="admin-input admin-textarea" maxlength="8000" style="font-family:monospace;font-size:0.85rem;min-height:8rem;"><?= $h($vm->artistDetailScheduleFallbacksJson) ?></textarea>
                </div>
                <div class="admin-field">
                    ...
                    <textarea id="artist_detail_music_profile_slots_json" name="artist_detail_music_profile_slots_json" class="admin-input admin-textarea" maxlength="4000" style="font-family:monospace;font-size:0.85rem;min-height:5rem;"><?= $h($vm->artistDetailMusicProfileSlotsJson) ?></textarea>
                </div>
                <div class="admin-field">
                    <label for="artist_detail_music_album_slots_json">Music block: album cover slot keys</label>
                    <textarea id="artist_detail_music_album_slots_json" name="artist_detail_music_album_slots_json" class="admin-input admin-textarea" maxlength="4000" style="font-family:monospace;font-size:0.85rem;min-height:5rem;"><?= $h($vm->artistDetailMusicAlbumSlotsJson) ?></textarea>
                </div>
                <div class="admin-field" style="display:flex;gap:1rem;flex-wrap:wrap;">
                    <div style="flex:1;min-width:12rem;">
                        ...
                        <input type="text" id="artist_detail_music_profile_fallback" name="artist_detail_music_profile_fallback" required maxlength="255"
                               value="<?= $h($vm->artistDetailMusicProfileFallback) ?>" class="admin-input">
                    </div>
                    <div style="flex:1;min-width:12rem;">
                        ...
                        <input type="text" id="artist_detail_music_album_fallback" name="artist_detail_music_album_fallback" required maxlength="255"
                               value="<?= $h($vm->artistDetailMusicAlbumFallback) ?>" class="admin-input">
                    </div>
                </div>
                <div class="admin-field" style="display:flex;gap:1rem;flex-wrap:wrap;">
                    <div style="flex:1;min-width:10rem;">
                    ...
                    <div style="flex:1;min-width:10rem;">
                        ...
                        <input type="text" id="artist_detail_default_album_title" name="artist_detail_default_album_title" required maxlength="120"
                               value="<?= $h($vm->artistDetailDefaultAlbumTitle) ?>" class="admin-input">
                    </div>
                    <div style="flex:1;min-width:10rem;">
                        ...
                        <input type="text" id="artist_detail_default_album_sub" name="artist_detail_default_album_sub" required maxlength="120"
                               value="<?= $h($vm->artistDetailDefaultAlbumSub) ?>" class="admin-input">
                    </div>
                </div>
                <div class="admin-field" style="display:flex;gap:1rem;flex-wrap:wrap;">
                    <div style="flex:1;min-width:8rem;">
                        ...
                        <input type="text" id="artist_detail_gallery_target_count" name="artist_detail_gallery_target_count" required maxlength="3" pattern="[0-9]+"
                               value="<?= $h($vm->artistDetailGalleryTargetCount) ?>" class="admin-input">
                    </div>
                    <div style="flex:1;min-width:8rem;">
                        ...
                        <input type="text" id="artist_detail_hero_tagline_max_chars" name="artist_detail_hero_tagline_max_chars" required maxlength="3" pattern="[0-9]+"
                               value="<?= $h($vm->artistDetailHeroTaglineMaxChars) ?>" class="admin-input">
                    </div>
                </div>
                <div class="admin-field">
                    <label for="artist_detail_gallery_stats_json">Stats row fallback (JSON array of <code>{"num","label"}</code>)</label>
                    <textarea id="artist_detail_gallery_stats_json" name="artist_detail_gallery_stats_json" class="admin-input admin-textarea" maxlength="4000" style="font-family:monospace;font-size:0.85rem;min-height:6rem;"><?= $h($vm->artistDetailGalleryStatsJson) ?></textarea>
                </div>
            </fieldset>
