...
class EventTypesDisplaySeeder extends AbstractSeed
{
    public function run(): void
    {
        ...
        $adapter->execute("UPDATE event_types SET card_image = 'jazz.jpg', info_path = 'jazz' WHERE name = 'jazz'");
        $adapter->execute("UPDATE event_types SET card_image = 'history.png', info_path = 'history' WHERE name = 'history'");
