    ...
    public function run(): void
    {
        ...
        $rows = [
            [
                ...
                'image_path'  => '/images/Stories/events/winnie-de-poeh-event.jpg',
                'story_type'  => 'Story',
                'age'         => '4+',
                'language'    => 'NL',
                'template'    => 'generic',
            ...
            [
                ...
                'image_path'  => '/images/Stories/events/omdenken-podcast-event.jpg',
                'story_type'  => 'Podcast',
                'age'         => '16+',
                'language'    => 'NL',
                'template'    => 'omdenken',
            ...
            [
                ...
                'image_path'  => '/images/Stories/events/buurderij-haarlem-event.jpg',
                'story_type'  => 'Story',
                'age'         => '16+',
                'language'    => 'ENG',
                'template'    => 'buurderij',
        ...
        foreach ($rows as $r) {
            ...
            if (($titleCounts[$titleKey] ?? 0) > 1 && $rowDay === '') {
                echo "[SKIP] Ambiguous title, add event_day: {$r['event_title']}\n";
                continue;
            }

            if ($rowDay !== '') {
                if (!isset($eventByTitleDay[$fullKey])) {
                    echo "[SKIP] Not found (title/day): {$r['event_title']} | {$rowDay}\n";
                    continue;
                }
                $event = $eventByTitleDay[$fullKey];
            } else {
                if (!isset($eventByTitle[$titleKey])) {
                    echo "[SKIP] Not found (title): {$r['event_title']}\n";
                    continue;
                }
